 ...
 */
@interface MZImageCache : NSObject
 ...
 *
 * @return MZImageCache global instance
 */
+ (MZImageCache *)sharedImageCache;
...
/**
 * Add a read-only cache path to search for images pre-cached by MZImageCache
