...
#define MZShare_DefaultImage  [UIImage imageNamed:@"mz_channelShare_placeHolder"]
...
//默认图片
//头像
#define MZ_UserIcon_DefaultImage [UIImage imageNamed:@"mz_personPlaceHold"]
//活动封面
#define MZ_FocusDefaultImage     [UIImage imageNamed:@"mz_cover_default"]//尺寸大约 16：9
//头像-SDK
#define MZ_SDK_UserIcon_DefaultImage [UIImage imageNamed:@"avatar_placeholder"]
//活动封面-SDK
#define MZ_SDK_FocusDefaultImage     [UIImage imageNamed:@"cover_default"]

//(barnner)活动封面
#define MZ_BarnnerFocusDefaultImage     [UIImage imageNamed:@"mz_barnnerCover_default"]//尺寸大约 3：1

//(商品)详情占位图
#define MZ_GoodsFocusDefaultImage     [UIImage imageNamed:@"MZ_GoodsFocusDefaultImage"]//尺寸大约 1：1

//(图文广告)活动封面
#define MZ_ADFocusDefaultImage     [UIImage imageNamed:@"MZ_ADFocusDefaultImage"]


//礼物
#define MZ_GiftDefaultImage      [UIImage imageNamed:@"mz_gift_placeHolder"]
//等级
#define MZ_Level_Image(a)        [UIImage imageNamed:[NSString stringWithFormat:@"v%@",a]]
//更多--频道
#define MZ_ChannelDefaultImage   [UIImage imageNamed:@"mz_cover_default"]

//频道分享默认
#define MZ_ChannelShareDefaultImage  [UIImage imageNamed:@"mz_channelShare_placeHolder"]
//商品图片默认图
#define MZ_GoodsPlaceHolder   [UIImage imageNamed:@"mz_goods_defaultImage"]
//mz_qrDefaultImage
#define MZ_QrPlaceHolder      [UIImage imageNamed:@"mz_qrDefaultImage"]
