//
//  MZAnimationTransitionController.h
//  MZtie
//
...
/** MZAnimationTransitionController
 *
 *  This class creates a custom UIViewController transition animation
 *  using a MZtie animation to transition between two view controllers
...
@interface MZAnimationTransitionController : NSObject <UIViewControllerAnimatedTransitioning>

/**
 The initializer to create a new transition animation.
 
 @param animation The name of the MZtie Animation to load for the transition
 
 @param fromLayer The name of the custom layer to mask the fromVC screenshot with.
 If no layer is specified then the screenshot is added behind the MZtie Animation
 
 @param toLayer The name of the custom layer to mask the toVC screenshot with.
 If no layer is specified then the screenshot is added behind the MZtie Animation
 and a fade transition is performed along with the MZtie animation.
