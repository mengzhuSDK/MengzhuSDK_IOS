...
#import "MZCLUPnPResponseDelegate.h"

@class MZCLUPnPDevice;
@interface MZCLUPnPRenderer : NSObject

@property (nonatomic, strong) MZCLUPnPDevice *model;

@property (nonatomic, strong) id<MZCLUPnPResponseDelegate>delegate;
...
/**
 ...
 @return self
 */
- (instancetype)initWithModel:(MZCLUPnPDevice *)model;
