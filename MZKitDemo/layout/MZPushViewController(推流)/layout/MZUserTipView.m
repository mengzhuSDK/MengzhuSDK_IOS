...
-(void)setupUI
{
    ...
    self.headerImageV.image = MZ_UserIcon_DefaultImage;
    [centerView addSubview:self.headerImageV];
    [self.headerImageV sd_setImageWithURL:[NSURL URLWithString:[MZUserServer currentUser].avatar] placeholderImage:MZ_UserIcon_DefaultImage];
    ...
    self.tipLabel.text = [NSString stringWithFormat:@"确认要将%@禁言吗？",[MZUserServer currentUser].nickName];
...
-(void)setOtherUser:(MZLiveUserModel *)otherUser
{
    ...
    [self.headerImageV sd_setImageWithURL:[NSURL URLWithString:otherUser.avatar] placeholderImage:MZ_UserIcon_DefaultImage];
