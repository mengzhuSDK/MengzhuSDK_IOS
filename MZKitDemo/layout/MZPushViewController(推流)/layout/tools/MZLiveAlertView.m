...
-(void)showInWithView:(UIView *)view title:(NSString *)title leftBtn:(NSString *)leftBtnStr rightBtn:(NSString *)rightBtnStr clickBlock:(AlertViewClickBlock )clickBlock;
{
    ...
    if (isLandScapeRate) {
        ...
        CGFloat titleH = [MZGlobalTools getLabelHeightWithText:title width:236*landScapeRate font:14*landScapeRate];
        ...
        CGFloat titleH = [MZGlobalTools getLabelHeightWithText:title width:236*MZ_RATE font:14*MZ_RATE];
