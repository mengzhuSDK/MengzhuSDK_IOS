...
- (void)layoutUI
{
    ...
    if (!_errorBtn) {
        ...
        [_errorBtn setBackgroundImage:[MZGlobalTools imageWithColor:MakeColorRGBA(0xffffff, 1.0) size:CGSizeMake(1, 1)] forState:UIControlStateNormal];
        [_errorBtn setBackgroundImage:[MZGlobalTools imageWithColor:MakeColorRGBA(0xff5b29, 0.1) size:CGSizeMake(1, 1)] forState:UIControlStateHighlighted];
    ...
    if (!_noDataBtn) {
        ...
        [_noDataBtn setBackgroundImage:[MZGlobalTools imageWithColor:MakeColorRGBA(0xffffff, 1.0) size:CGSizeMake(1, 1)] forState:UIControlStateNormal];
        [_noDataBtn setBackgroundImage:[MZGlobalTools imageWithColor:MakeColorRGBA(0x8e9091, 0.1) size:CGSizeMake(1, 1)] forState:UIControlStateHighlighted];
...
- (void)setNoDataBtnBgColor:(UIColor *)noDataBtnBgColor
{
   const CGFloat *components = CGColorGetComponents(noDataBtnBgColor.CGColor);
    if (_noDataBtnTitle.length) {
        [_noDataBtn setBackgroundImage:[MZGlobalTools imageWithColor:noDataBtnBgColor size:CGSizeMake(1, 1)] forState:UIControlStateNormal];
        [_noDataBtn setBackgroundImage:[MZGlobalTools imageWithColor:[UIColor colorWithRed:components[0] green:components[1] blue:components[2] alpha:0.9] size:CGSizeMake(1, 1)] forState:UIControlStateHighlighted];
