...
#define NavColor        [UIColor colorWithRed:25/255.0 green:24/255.0 blue:29/255.0 alpha:0.3]
...
- (id)initWithImage:(UIImage *)originalImage cropFrame:(CGRect)cropFrame limitScaleRatio:(NSInteger)limitRatio {
    ...
    if (self) {
        ...
        self.view.backgroundColor = MakeColorRGB(0xe2e8eb);
    }
    return self;
}
...
- (void)initControlBtn {
    ...
    float bottomSpace = IPHONE_X ? 34 : 0;
    
    UIView* view = [[UIView alloc]initWithFrame:CGRectMake(0,  self.view.frame.size.height - 50.0f - bottomSpace, self.view.frame.size.width, 50)];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(view.width - 100.0f, 0, 100, 50)];
    confirmBtn.backgroundColor = NavColor;
