...
@property (nonatomic ,strong)MZMyButton *onlineIconBtn;
...
- (void)addOnline:(MZLongPollDataModel *)pollingDate
{
    ...
    if(!self.onlineIconBtn){
        self.onlineIconBtn = [[[MZMyButton alloc] init]roundChangeWithRadius:13*MZ_RATE];
    ...
    [self.onlineIconBtn setTitle:tempStr forState:UIControlStateNormal];
