...
@property (nonatomic ,strong)MLEmojiLabel *chatTextLabel;
...
-(void)setupUI
{
    if ([_MZMsgType isEqualToString:MZMsgTypeMeChat] || [_MZMsgType isEqualToString:MZMsgTypeOtherChat]) {//t我和他人的文字和图片信息
        ...
        self.chatTextLabel = [[MLEmojiLabel alloc]initWithFrame:CGRectZero];
        ...
        self.chatTextLabel.isNeedAtAndPoundSign = YES;
        self.chatTextLabel.disableThreeCommon = YES;
