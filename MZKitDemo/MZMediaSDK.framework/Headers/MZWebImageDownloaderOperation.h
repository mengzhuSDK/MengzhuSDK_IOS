...
@interface MZWebImageDownloaderOperation : NSOperation <MZWebImageOperation, NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
...
/**
 *  Initializes a `MZWebImageDownloaderOperation` object
 *
 *  @see MZWebImageDownloaderOperation
 *
