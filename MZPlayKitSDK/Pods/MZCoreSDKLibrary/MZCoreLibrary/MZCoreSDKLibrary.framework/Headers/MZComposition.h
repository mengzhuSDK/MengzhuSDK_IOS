...
@interface MZComposition : NSObject
...
@property (nonatomic, strong, readonly, nullable) MZLayerGroup *layerGroup;
@property (nonatomic, strong, readonly, nullable) MZAssetGroup *assetGroup;
