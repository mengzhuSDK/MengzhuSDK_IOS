...
@interface MZBaseGlobalTools : NSObject
...
//专门为app使用的MD5，盟主app一定不要用错
+ (NSString*)APPMD5WithUrl:(NSString*)url Param:(NSDictionary *)param;
...
+(NSString *)getNowTimeTimestamp;//获取毫秒
...
+(NSString *)getSHowStringWithMoney:(NSString *)money;//打赏数字对应的文字
