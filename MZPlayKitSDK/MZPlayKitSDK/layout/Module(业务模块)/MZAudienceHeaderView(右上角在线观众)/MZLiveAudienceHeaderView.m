...
-(void)setUserArr:(NSArray *)userArr
{
    _userArr = userArr;
    if(userArr.count >= 3){
        [self.headBtnOne sd_setImageWithURL:[NSURL URLWithString:((MZOnlineUserListModel *)userArr[0]).avatar] forState:UIControlStateNormal placeholderImage:MZ_SDK_UserIcon_DefaultImage];
        [self.headBtnTwo sd_setImageWithURL:[NSURL URLWithString:((MZOnlineUserListModel *)userArr[1]).avatar] forState:UIControlStateNormal placeholderImage:MZ_SDK_UserIcon_DefaultImage];
        [self.headBtnThree sd_setImageWithURL:[NSURL URLWithString:((MZOnlineUserListModel *)userArr[2]).avatar] forState:UIControlStateNormal placeholderImage:MZ_SDK_UserIcon_DefaultImage];
        ...
        self.headBtnOne.hidden = YES;
        [self.headBtnTwo sd_setImageWithURL:[NSURL URLWithString:((MZOnlineUserListModel *)userArr[0]).avatar] forState:UIControlStateNormal placeholderImage:MZ_SDK_UserIcon_DefaultImage];
        [self.headBtnThree sd_setImageWithURL:[NSURL URLWithString:((MZOnlineUserListModel *)userArr[1]).avatar] forState:UIControlStateNormal placeholderImage:MZ_SDK_UserIcon_DefaultImage];
        self.headBtnTwo.hidden = NO;
        self.headBtnThree.hidden = NO;
        self.numLabel.hidden = NO;
    }else if (userArr.count == 1){
        [self.headBtnThree sd_setImageWithURL:[NSURL URLWithString:((MZOnlineUserListModel *)userArr[0]).avatar] forState:UIControlStateNormal placeholderImage:MZ_SDK_UserIcon_DefaultImage];
        self.headBtnOne.hidden = YES;
        self.headBtnTwo.hidden = YES;
        self.headBtnThree.hidden = NO;
        self.numLabel.hidden = NO;
