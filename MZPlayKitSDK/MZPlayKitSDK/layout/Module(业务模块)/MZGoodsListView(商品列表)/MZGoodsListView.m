...
- (void)setupUI {
    ...
    [MZBaseGlobalTools bezierPathWithRoundedRect:headerView.bounds radius:16*relastiveRate view:headerView byRoundingCorners:UIRectCornerTopLeft | UIRectCornerTopRight];
