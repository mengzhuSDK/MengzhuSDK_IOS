...
- (void)addMeTalk:(MZLongPollDataModel*)pollingDate
{
    ...
    tap.userName= [MZBaseGlobalTools cutStringWithString:pollingDate.userName SizeOf:12];
...
//    }
    ...
    [iconBtn sd_setImageWithURL:[NSURL URLWithString:pollingDate.userAvatar] forState:UIControlStateNormal placeholderImage:MZ_SDK_UserIcon_DefaultImage];
...
////    NSString * tempStr =[MZBaseGlobalTools cutStringWithString:pollingDate.userName SizeOf:12];
////    tempStr = [NSString stringWithFormat:@"%@ 来了",tempStr];
//    self.onlineIconBtn.title = pollingDate.userName;
////    CGSize strSize = [MZBaseGlobalTools calStrSize:tempStr width:MAXFLOAT font:[UIFont systemFontOfSize:12*MZ_RATE]];
