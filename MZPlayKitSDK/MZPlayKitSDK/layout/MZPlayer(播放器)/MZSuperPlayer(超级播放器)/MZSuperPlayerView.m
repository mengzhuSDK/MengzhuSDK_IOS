...
- (void)layoutSubviews {
    ...
    // 礼物按钮
    self.giftButton.frame = CGRectMake(self.shareBtn.left - 3 - 44*self.relativeSafeRate, self.shoppingBagButton.frame.origin.y, 44*self.relativeSafeRate, 44*self.relativeSafeRate);
    // 多菜单按钮
