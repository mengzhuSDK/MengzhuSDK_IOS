...
/** 默认的列数*/
static const NSInteger MZC_DefaultColumeCount = 2;
/** 默认的行数*/
static const NSInteger MZC_DefaultRowCount = 5;

/** 每一列之间的间距*/
static const NSInteger MZC_DefaultColumeMargin = 10;
/** 每一行之间的间距*/
static const CGFloat MZC_DefaultRowMargin = 10;
/** 边缘之间的间距*/
static const UIEdgeInsets MZC_DefaultEdgeInset = {10, 10, 10, 10};

///** 每一行之间的间距*/
//static const CGSize MZC_DefaultHeaderSize = CGSizeMake(0, 66);
///** 每一行之间的间距*/
//static const CGSize MZC_DefaultFooterSize = CGSizeMake(0, 66);


@interface MZC_WaterFlowLayout ()
...
@implementation MZC_WaterFlowLayout
...
-(CGFloat)columnMargin {
    if ([self.delegate respondsToSelector:@selector(columnMarginInWaterFlowLayout:)]) {
        ...
        return  MZC_DefaultColumeMargin;
    }
}
...
-(void)prepareLayout {
    ...
    if (self.flowLayoutStyle == MZC_WaterFlowVerticalEqualWidth) {
    ...
    }else if (self.flowLayoutStyle == MZC_WaterFlowHorizontalEqualHeight){
    ...
    }else if (self.flowLayoutStyle == MZC_WaterFlowVerticalEqualHeight || self.flowLayoutStyle == MZC_LineWaterFlow){
    ...
    }else if(self.flowLayoutStyle == MZC_WaterFlowHorizontalGrid){
...
-(UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    }else if(self.flowLayoutStyle == MZC_WaterFlowVerticalEqualHeight){
        
        attrs.frame = [self itemFrameOfVHWaterFlow:indexPath];
        
    }else if(self.flowLayoutStyle == MZC_LineWaterFlow){
...
/*
 ...
 {
 if (self.flowLayoutStyle == MZC_LineWaterFlow) {
