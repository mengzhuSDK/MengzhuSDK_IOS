...
- (void)layoutUI
{
    ...
    [takePhotoBtn setBackgroundImage:[MZBaseGlobalTools imageWithColor:MakeColorRGBA(0xffffff, 1.0) size:CGSizeMake(1, 1)] forState:UIControlStateNormal];
    [takePhotoBtn setBackgroundImage:[MZBaseGlobalTools imageWithColor:MakeColorRGBA(0xffffff, 0.7) size:CGSizeMake(1, 1)] forState:UIControlStateSelected];
    [takePhotoBtn setBackgroundImage:[MZBaseGlobalTools imageWithColor:MakeColorRGBA(0xffffff, 0.7) size:CGSizeMake(1, 1)] forState:UIControlStateHighlighted];
