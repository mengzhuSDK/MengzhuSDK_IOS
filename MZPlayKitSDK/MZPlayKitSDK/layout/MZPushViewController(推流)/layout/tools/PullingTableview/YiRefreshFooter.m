...
#define kRefreshHeaderTitleEnd     @"没有更多了..."

#define kTextColor [UIColor colorWithRed:127/255.0 green:127/255.0 blue:127/255.0 alpha:1]
...
- (void)footer
{
    ...
    float imageWidth=25;
    footerLabel=[[UILabel alloc] initWithFrame:CGRectMake((scrollWidth-labelWidth)/2, 0, labelWidth, footerHeight)];
    ...
    footerIV=[[UIImageView alloc] initWithFrame:CGRectMake((scrollWidth-labelWidth)/2-imageWidth, (footerHeight-imageWidth)/2, imageWidth, imageWidth)];
