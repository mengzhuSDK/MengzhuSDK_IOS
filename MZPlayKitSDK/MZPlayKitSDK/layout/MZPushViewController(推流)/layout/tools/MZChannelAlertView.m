...
- (void)layoutUIWithType:(int)type //1 表示两个按钮    2 表示只有一个按钮
{
    ...
    if (!_cannelBtn) {
        ...
        [_cannelBtn setBackgroundImage:[MZBaseGlobalTools imageWithColor:MakeColorRGBA(0xe9e9e9, 1.0) size:CGSizeMake(1, 1)] forState:UIControlStateNormal];
        [_cannelBtn setBackgroundImage:[MZBaseGlobalTools imageWithColor:MakeColorRGBA(0xe9e9e9, 0.8) size:CGSizeMake(1, 1)] forState:UIControlStateSelected];
        [_cannelBtn setBackgroundImage:[MZBaseGlobalTools imageWithColor:MakeColorRGBA(0xe9e9e9, 0.8) size:CGSizeMake(1, 1)] forState:UIControlStateHighlighted];
    ...
    if (!_sureBtn) {
        ...
        [_sureBtn setBackgroundImage:[MZBaseGlobalTools imageWithColor:MakeColorRGBA(0xff5b29, 1.0) size:CGSizeMake(1, 1)] forState:UIControlStateNormal];
        [_sureBtn setBackgroundImage:[MZBaseGlobalTools imageWithColor:MakeColorRGBA(0xff5b29, 0.90) size:CGSizeMake(1, 1)] forState:UIControlStateHighlighted];
        [_sureBtn setBackgroundImage:[MZBaseGlobalTools imageWithColor:MakeColorRGBA(0xff5b29, 0.90) size:CGSizeMake(1, 1)] forState:UIControlStateSelected];
    ...
    if (type == 2) {
        ...
        [_cannelBtn setBackgroundImage:[MZBaseGlobalTools imageWithColor:MakeColorRGBA(0xff5b29, 1.0) size:CGSizeMake(1, 1)] forState:UIControlStateNormal];
        [_cannelBtn setBackgroundImage:[MZBaseGlobalTools imageWithColor:MakeColorRGBA(0xff5b29, 0.8) size:CGSizeMake(1, 1)] forState:UIControlStateSelected];
        [_cannelBtn setBackgroundImage:[MZBaseGlobalTools imageWithColor:MakeColorRGBA(0xff5b29, 0.8) size:CGSizeMake(1, 1)] forState:UIControlStateHighlighted];
    ...
    if(type == 3){
        ...
        [_cannelBtn setBackgroundImage:[MZBaseGlobalTools imageWithColor:_color size:CGSizeMake(1, 1)] forState:UIControlStateNormal];
        [_cannelBtn setBackgroundImage:[MZBaseGlobalTools imageWithColor:_color size:CGSizeMake(1, 1)] forState:UIControlStateHighlighted];
        [_cannelBtn setBackgroundImage:[MZBaseGlobalTools imageWithColor:_color size:CGSizeMake(1, 1)] forState:UIControlStateSelected];
    }
}
