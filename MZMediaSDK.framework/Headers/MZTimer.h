...
/**
 MZTimer is a thread-safe timer based on GCD. It has similar API with `NSTimer`.
 MZTimer object differ from NSTimer in a few ways:
...
+ (MZTimer *)timerWithTimeInterval:(NSTimeInterval)interval
                            target:(id)target
